...
interface GenreStoriesClientProps {
  ...
  return (
    <div className="text-center py-16 animate-fade-in">
      ...
      <p className="text-muted-foreground max-w-md mx-auto mb-6">
        There are no stories in this genre yet. Check back soon or explore
        other genres to discover amazing stories.
      </p>
      <div className="flex gap-3 justify-center">
        <Link href="/genres">
          <Button variant="outline">Browse Other Genres</Button>
        </Link>
        <Link href="/themes">
...
export function GenreStoriesClient({
  initialStories,
  initialPagination,
  genreSlug,
  currentSort,
  currentLimit,
}: GenreStoriesClientProps) {
  ...
  }, [currentPage, sortBy, limit, genreSlug, initialPagination]);
