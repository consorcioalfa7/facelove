...
const valuePropositions = [
  {
    ...
    description: "Seus dados protegidos com criptografia de ponta. Leia com total anonimato.",
    Icon: ShieldCheck,
  ...
  {
    id: "real-content",
    title: "Histórias autênticas",
    description: "Conteúdo criado por autores reais, com narrativas que emocionam e conectam.",
    Icon: Heart,
  ...
  },
  {
    ...
    description: "Conecte-se com milhares de leitores e autores em um ambiente premium.",
    Icon: Users,
  ...
  },
  {
    id: "multilingual",
    title: "Acesso global",
    description: "Disponível em 14 idiomas para leitores do mundo todo.",
    Icon: Globe,
